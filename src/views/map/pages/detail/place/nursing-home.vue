  ...
  <div>
    <div v-show="!showMap" class="page">
      <div class="header-info">
        <p class="title">{{ this.state.orgOfficeName }}</p>
        <!-- <rate-price
          :score="score"
          :price="price"
        ></rate-price> -->
      ...
      <expand-text id="exp2" title="养老院信息" :article="state.common_service_intro" />
...
export default {
  ...
  methods: {
    async getDetail() {
      ...
      console.log("🚀 ~ file: nursing-home.vue ~ line 134 ~ getDetail ~ this.state", this.state)
