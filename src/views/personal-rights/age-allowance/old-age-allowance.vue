 ...
 * @Version: 1.0.0
 * @Author: Chendh
 * @Date: 2021-07-24 14:11:39
-->
<template>
  <div class="page-old-age-allowance">
    <div class="card">
    ...
    <section class="container">
      <div v-for="(item, index) in state.detail" :key="index" @click="jumpPage" class="item">
        <p class="date">{{ item.endAccountDate }}</p>
        <div class="content">
          <div class="left">
...
export default {
  ...
  methods: {
    async getData() {
      ...
      this.state = data.ageAllowance[this.query.year][this.query.place]
      console.log("state", data.ageAllowance)
    },
    strToDate(datestr) {
